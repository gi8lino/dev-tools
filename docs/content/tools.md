...
The release ships five standalone executable helpers. Maintained source scripts live under `scripts/`; release assets use the short executable names shown here.
